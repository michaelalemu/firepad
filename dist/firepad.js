...
firepad.RichTextToolbar = (function (global) {
  ...
  RichTextToolbar.prototype.makeElement2_ = function () {
    var self = this;
    var font = this.makeFontDropdown_();
    var fontSize = this.makeFontSizeDropdown_();
    var color = this.makeColorDropdown_();
    var toolbarOptions = [
      // utils.elt('div', [font], { 'class': 'v-item-group'}),
      // utils.elt('div', [fontSize], { 'class': 'v-item-group'}),
      // utils.elt('div', [color], { 'class': 'v-item-group'}),
      utils.elt(
        "div",
        [
          self.makeButton_("bold", "format_bold"),
          self.makeButton_("italic", "format_italic"),
          self.makeButton_("underline", "format_underline"),
          self.makeButton_("strike", "strikethrough_s"),
        ],
        { class: "v-item-group v-btn-toggle" }
      ),
      // utils.elt('div', [self.makeButton_('unordered-list', 'list-2'), self.makeButton_('ordered-list', 'numbered-list'), self.makeButton_('todo-list', 'list')], { 'class': 'v-item-group'}),
      // utils.elt('div', [self.makeButton_('indent-decrease'), self.makeButton_('indent-increase')], { 'class': 'v-item-group'}),
      // utils.elt('div', [self.makeButton_('left', 'paragraph-left'), self.makeButton_('center', 'paragraph-center'), self.makeButton_('right', 'paragraph-right')], { 'class': 'v-item-group'}),
      // utils.elt('div', [self.makeButton_('undo'), self.makeButton_('redo')], { 'class': 'v-item-group'})
    ];
    if (self.imageInsertionUI) {
      // toolbarOptions.push(utils.elt('div', [self.makeButton_('insert-image')], { 'class': 'v-item-group' }));
    }
    var toolbarWrapper = utils.elt("div", toolbarOptions, {
      class: "firepad-toolbar-wrapper",
    });
  ...
  RichTextToolbar.prototype.makeFontDropdown_ = function () {
    ...
    return this.makeDropdown_("Schriftart", "font", items);
  };
  ...
  RichTextToolbar.prototype.makeFontSizeDropdown_ = function () {
    ...
    return this.makeDropdown_("Größe", "font-size", items, "px");
  };
  ...
  RichTextToolbar.prototype.makeColorDropdown_ = function () {
    ...
    return this.makeDropdown_("Farbe", "color", items);
  };
...
firepad.RichTextCodeMirror = (function () {
  ...
  function RichTextCodeMirror(codeMirror, entityManager, options) {
    ...
    if (parseInt(global.CodeMirror.version) >= 4) {
...
firepad.Firepad = (function (global) {
  ...
  function Firepad(ref, place, options) {
    ...
    var displayName = this.getOption("userDisplayName", "");
